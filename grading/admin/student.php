...
?>
        <div id="content-wrapper" class="d-flex flex-column page">
            <div id="content">
                    ...
                    <h5 class="h5 mb-0 text-gray-800">STUDENT</h5>
                    </div>
                    </div>
                    <div class="row d-flex justify-content-center">
                    <div class="card shadow mb-4" style="width: 95%;">
                        <div class="card-header" style="background-color: #0C2764">
                            <nav aria-label="breadcrumb" role="navigation" style="height: 45px; width: 134px">
                                <ol class="breadcrumb" style="padding-top: 5px; padding-bottom: 5px">
                                        <li class="breadcrumb-item">
                                        <button class="btn-round btn-primary btn-sm" data-toggle="modal" data-target="#addstudent">Add Student</button>
                            ...
                            <div class="table-responsive">
                                ...
                                <th scope="col" style="width: 100px !important;">Option</th>
                                    ...
                                    <?php
                                        ...
                                        $start = ($page -1) * $limit;
                                        $query = "SELECT * FROM tbl_students LIMIT $start, $limit";
                                        $result = mysqli_query($con,$query);

                                        $query1 = $con->query("SELECT count(student_id) AS id FROM tbl_students");
                                        ...
                                        <tr style="text-align: center">
                                            ...
                                            <button type="button" value="<?php echo $row['student_id'];?>" class="btn-round btn-sm btn-danger deletebtn" style="font-size:10px"><i class="fas fa-trash"></i></button>
                                            </td>
                                        </tr>
                                    </tbody>
    ...
    <div class="modal-content">
      ...
      <h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edit Student</h4>
        ...
        <div class="modal-body">
            ...
            <form action="edit_function.php" method="post">
                <div class="form-group">
                    <p>LRN <input type="number" class="form-control" name="lrn" id="lrn" placeholder="LRN" style='text-align: center;' required/></p>
                </div>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="update_student" class="btn-round btn-primary btn-sm">Save Changes</button>
            </form>
        </div>
    </div>
  </div>
