  ...
  z-index: 2;
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4" style="width: 80%;">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        $query = mysqli_query($con,"SELECT * FROM tbl_admin WHERE admin_id='".$_SESSION['admin_id']."'");
                                        while($row = mysqli_fetch_array($query)){
                                          $uname = $row['username'];
                                          $pass = $row['password'];
                                          $lname = $row['lastname'];
                                          $fname = $row['firstname'];
                                          $mid = $row['middle_initial'];
                                      }
                                      ?>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <button type="submit" name="update_admin" class="btn btn-primary btn-sm">Update Profile</button>
                                </form>
                            </div>
                </div>
            </div>
    ...
    <?php
         ...
         {   
             ...
             if($password == $cpass){                 
                    $sql = "UPDATE tbl_admin SET username='$username',password='$password' WHERE admin_id='".$_SESSION['admin_id']."'";
