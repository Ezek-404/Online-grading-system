            ...
            <div id="content">
                ...
                <div class="card shadow mb-4" style="width: 80%;">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        $query = mysqli_query($con,"SELECT * FROM tbl_students WHERE student_id='".$_SESSION['student_id']."'");
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <button type="submit" name="update_student" class="btn btn-primary btn-sm">Update Profile</button>
                                </form>
                            </div>
    ...
    <?php
         ...
         {   
             ...
             $cpass = $_POST['cpass'];
                ...
                if($password == $cpass){
                    $sql = "UPDATE tbl_students SET username='$username',password='$password' WHERE student_id='".$_SESSION['student_id']."'";
